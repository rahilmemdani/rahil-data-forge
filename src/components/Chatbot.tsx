...
return (
  <>
    {isVisible && (
      <div className="fixed bottom-6 right-6 z-50 w-[400px] h-[600px] bg-slate-100 rounded-xl shadow-2xl flex flex-col overflow-hidden border border-slate-300">
        {/* Header */}
    ...
    {!isVisible && (
      <button
        className="fixed bottom-6 right-6 z-50 bg-primary text-white p-4 rounded-full shadow-xl hover:bg-primary transition"
